...
angular.module('mean.hawtiotheme').provider('sgKeycloak', function() {
...
angular.module('mean.hawtiotheme').factory('KeycloakRestangular', ['Restangular', 'sgKeycloak', function(Restangular, sgKeycloak) {
    return Restangular.withConfig(function(RestangularConfigurer) {
        RestangularConfigurer.setBaseUrl(sgKeycloak.getRestUrl());
    });
}]);

angular.module('mean.hawtiotheme').factory('SGUsuarioKeycloak', ['KeycloakRestangular',  function(KeycloakRestangular) {
